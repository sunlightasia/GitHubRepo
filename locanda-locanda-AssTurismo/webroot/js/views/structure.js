...
window.EditStructureView = EditView.extend({
    ...
    initialize: function () {
        ...
        this.facilitiesListView = new FacilitiesListView({
            collection: new StructureFacilities({}, {
                id: this.model.get("id")
            })
        });
        this.facilitiesListView.availableCollection = new AvailableStructureFacilities({}, {
            id: this.model.get("id")
        });
        this.imagesListView = new ImagesListView({
            collection: new StructureImages({}, {
                id: this.model.get("id")
            })
        });
