...
window.PropertyTypes = Backbone.Collection.extend({
    ...
    url: function () {
    	return 'rest/propertyTypes/search' + this.from + this.to + '/?term=' + this.term;
        //return 'rest/propertyTypes/structure/' + this.idWrapper + '/search' + this.from + this.to + '/?term=' + this.term;
    	//return 'rest/propertyTypes/search/all';
    },
